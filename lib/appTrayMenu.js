...
export const AppTrayMenu = GObject.registerClass(
  ...
  class AppTrayMenu extends PanelMenu.Button {
    ...
    _buildMenu() {
      ...
      this._contextTitle.clutter_text.ellipsize = Pango.EllipsizeMode.END;
    ...
    _rebuildGrid() {
      ...
      const configuredColumns = clamp(this.settings.get_int('grid-columns') || 4, 2, MAX_COLUMNS);
      const width = Math.max(320, configuredColumns * (CELL_SIZE + GRID_GAP) - GRID_GAP);
